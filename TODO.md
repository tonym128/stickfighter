...
- [x] Add kick back for hits so the characters are a little further apart after a strike
- [x] Stop spamming of attacks resulting in quick victories
...
- [x] Add a little bit of dynamic movement to the legs like the upper body and arms
